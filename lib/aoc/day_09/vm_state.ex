defmodule AOC.Day09.VmState do
  alias AOC.Day09.OpCode
  ...
  def read(state, location) do
    Map.get(state.memory_buffer, location, 0)
  end
  ...
  defp read_opcode_and_flags(state) do
    ip_input = Map.get(state.memory_buffer, state.current_index, 0)
